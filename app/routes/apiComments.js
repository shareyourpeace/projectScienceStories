...
//            _id: user._id,
    ...
    // call Express function is called express.Router()
    // Below this is the FIRST API which is the signup API
module.exports = function(app, express, io) {
    ...
    // Below this is the FIRST API which is the signup API
    // create a New User OBJECT  pass things in user.js file
    api.post('/signup',function(req,res){
        ...
        var token = createToken(user);
          ...
          // save the new user data to db
        user.save(function(err){
              if(err) {
                  res.send(err);
                  return;
              }
           // if no error send a message   
              res.json({
                  success: true,
          ...
          // to TEST to see if the above api is return, return api;
          // go to server.js and require './app/routes/api'
          // add the middleware 
